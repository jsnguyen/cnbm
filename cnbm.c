...
*h;}int main(){int n=5e4,m= 3,t=1e4,i,j,
k;b z[m];for(i=0;i<m;i++)z[i].p= malloc(
32);z[0].m=2e30;z[0].p[0]=0;z[0].p[1]=0;
z[0].p[2]= 0; z[0].p[3]=0;z[1].m=1.8e27;
z[1].p[0]= 1.5e11;z[1].p[1]=0;z[1].p[2]=
...
;}for(i=0;i<m;i++)free(z[i].p);}//cnbody
